...
sides. What stands between here and
running the suite is now *breadth* — DDL, select-list expressions and
arithmetic — not the storage engine, the indexes or the protocol: every layer from pages to B-trees to the wire now both
