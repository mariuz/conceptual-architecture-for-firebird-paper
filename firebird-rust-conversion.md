...
date/time/timestamp in raw units, boolean; blob columns served as real
...
maintenance, INT128/DECFLOAT/TZ decode), not the protocol — so firebird-qa remains
