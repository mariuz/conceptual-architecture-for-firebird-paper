...
running the suite is now *breadth* — multi-segment and descending
indexes, DDL, the wider expression surface — not the storage engine or
the protocol: every layer from pages to B-trees to the wire now both
